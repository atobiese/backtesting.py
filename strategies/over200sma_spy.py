...
def get_signals():
    ...
    strategy_text = f'stock: {stck} \n' \
                    f'Strategy: \n' \
                    f'long if (above ema200 and cross ema20), \n' \
                    f'sell if  (below ema200 or below ema20 and KST_9signal>=KST) \n' \
    ...
    indicators0 = ['EMA200', 'EMA20', 'pointposbreak', 'pointnegbreak', 'EMA3']
    scatter0 = [False, False, True, True, False]
    colors0 = [None, 'blue', 'green', 'red', None, 'green', 'blue', 'green', 'brown']
    sub_indicators0 = ['KSTs_9', 'KST_10_15_20_30_10_10_10_15', 'total_signal', 'ema200_signal']
